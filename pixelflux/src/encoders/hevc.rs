...
mod x265 {
    ...
    impl Backend {
        ...
        pub fn encode(
            ...
            pic.planes = [
                planes.y.as_mut_ptr().cast(),
                planes.u.as_mut_ptr().cast(),
                planes.v.as_mut_ptr().cast(),
            ];
            pic.stride = [planes.width as c_int, planes.chroma_width() as c_int, planes.chroma_width() as c_int];
            pic.pts = pts as i64;
            pic.bitDepth = 8;
